"""
Main pipeline orchestration for the answer key processing system.
Coordinates the processing of answer keys and student submissions.
"""
...
from .config import DEFAULT_DATA_FOLDER, LOG_FORMAT, LOG_LEVEL
...
def main():
    ...
    Orchestrates the complete processing pipeline for answer keys and student submissions.
    """
    # Set up logging
...
# In this pipeline, we store the answer key and student submissions in one folder.
# For one exam, we'll have one folder with the answer key and the student submissions.
